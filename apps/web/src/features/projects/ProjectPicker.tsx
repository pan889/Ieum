 ...
 * 프로젝트가 옵션에 없었다. 세 번째는 `fetchAllProjects` 였다: 커서를
 * 끝까지 따라가되 상한(2000개)을 두었는데, 개발 DB 가 2334개가 되자 **똑같이**
 * 멈췄다. 끝까지 받는 것도 상한이 있으면 결국 잘린 목록이다.
 * `ux-principles.md` 4절이 그것을 금지하고 있는데 세 번 어겼다.
 *
