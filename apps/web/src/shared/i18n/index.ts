...
const resources = {
  en: { common: commonEn, auth: authEn, errors: errorsEn, projects: projectsEn },
  ko: { common: commonKo, auth: authKo, errors: errorsKo, projects: projectsKo },
} as const
...
export async function initI18n(locale: Locale = detectLocale()): Promise<typeof i18next> {
  await i18next
    ...
    .init({
      ...
      fallbackLng: 'en',
      defaultNS: 'common',
      ns: ['common', 'auth', 'errors', 'projects'],
