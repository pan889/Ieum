---
description: Ieum 의 통합 검색과 질의 언어 IQL — 이슈와 문서를 한 상자에서 찾고, 조건을 저장하고, 집계 리포트로 봅니다.
---

# 검색과 IQL

찾는 상자는 **하나**입니다. 이슈인지 문서인지 먼저 고르지 않아도 되고,
조건을 더 정확히 적고 싶을 때 쓰는 말이 IQL 입니다.

![통합 검색 결과 — 이슈와 문서가 한 목록에 섞여 나온다](../assets/search.png)

한 상자에서 이슈와 문서가 함께 나옵니다. 한국어는 형태소로 색인합니다.
